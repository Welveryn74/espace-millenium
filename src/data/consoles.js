export const CONSOLES = [
  ...
  },
  {
    ...
    bootText: "Sony Computer Entertainment\n\nPlayStation®",
    games: [
      { name: "Tekken 3", emoji: "👊", desc: "Eddy Gordo, le mec que tout le monde spammait avec ses coups de capoeira. \"Appuie sur tous les boutons en même temps\" c'était une vraie strat.", year: "1998" },
      { name: "Gran Turismo", emoji: "🏎️", desc: "Le vrai simulateur auto. Tu passais le permis dans le jeu avant de le passer dans la vraie vie. La Dodge Viper rouge, le rêve.", year: "1997" },
      { name: "Crash Bandicoot", emoji: "🦊", desc: "Le marsupial orange qui casse des caisses. Les niveaux de pont, la musique tribale, Aku Aku qui dit un truc bizarre quand tu le prends. Wumpa fruits forever.", year: "1996" },
      { name: "Spyro the Dragon", emoji: "🐉", desc: "Un petit dragon violet qui crache du feu et charge les moutons. Les niveaux secrets, les gemmes cachées, Sparx le libellule qui change de couleur selon ta vie.", year: "1998" },
      { name: "Metal Gear Solid", emoji: "🎖️", desc: "Solid Snake, la boîte en carton, le codec. Le combat contre Psycho Mantis où il fallait changer de port manette. Le jeu qui a rendu le stealth cool.", year: "1998" },
      { name: "Tomb Raider", emoji: "🏺", desc: "Lara Croft et ses polygones. Les énigmes, les pièges, les T-Rex dans les grottes. Tu sautais de pilier en pilier en retenant ton souffle.", year: "1996" },
      { name: "Final Fantasy VII", emoji: "⚔️", desc: "Cloud, Aerith, Sephiroth. Le jeu qui a fait pleurer toute une génération. Les 3 disques, les 80 heures de jeu. \"Ceux qui ne connaissent pas ne peuvent pas comprendre.\"", year: "1997" },
    ],
  },
  {
    id: "pc",
