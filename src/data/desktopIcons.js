export const DESKTOP_ICONS = [
  ...
  { id: "dehors", label: "Dehors !", emoji: "\u{1F333}", img: "/images/desktop/dehors.png" },
  ...
  { id: "caramail", label: "Caramail", emoji: "\u{1F4E7}", img: "/images/desktop/caramail.svg" },
];
