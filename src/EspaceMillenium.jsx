...
// ── Wallpaper Bliss SVG — couleurs solides (les références url(#id) ne fonctionnent pas en data URL CSS) ──
const _BLISS = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1600 900"><rect width="1600" height="900" fill="#98C6E0"/><rect y="0" width="1600" height="450" fill="#72AACC" opacity="0.6"/><ellipse cx="290" cy="208" rx="255" ry="78" fill="rgba(255,255,255,0.92)"/><ellipse cx="210" cy="232" rx="185" ry="60" fill="rgba(255,255,255,0.86)"/><ellipse cx="390" cy="190" rx="200" ry="65" fill="rgba(255,255,255,0.82)"/><ellipse cx="145" cy="252" rx="145" ry="46" fill="rgba(255,255,255,0.76)"/><ellipse cx="1230" cy="182" rx="235" ry="70" fill="rgba(255,255,255,0.88)"/><ellipse cx="1130" cy="206" rx="175" ry="56" fill="rgba(255,255,255,0.82)"/><ellipse cx="1370" cy="194" rx="175" ry="55" fill="rgba(255,255,255,0.74)"/><ellipse cx="1490" cy="218" rx="128" ry="42" fill="rgba(255,255,255,0.65)"/><ellipse cx="780" cy="142" rx="155" ry="47" fill="rgba(255,255,255,0.66)"/><ellipse cx="648" cy="166" rx="118" ry="37" fill="rgba(255,255,255,0.58)"/><ellipse cx="988" cy="158" rx="118" ry="37" fill="rgba(255,255,255,0.54)"/><path d="M-80,900 C50,480 150,555 300,595 C430,628 510,590 600,558 C672,530 744,524 840,506 C928,490 998,500 1080,528 C1168,558 1228,555 1328,525 C1428,495 1528,548 1680,572 L1680,900 Z" fill="#52A832"/><path d="M-80,900 C50,480 150,555 300,595 C430,628 510,590 600,558 C672,530 744,524 840,506 C928,490 998,500 1080,528 C1168,558 1228,555 1328,525 C1428,495 1528,548 1680,572 L1680,900 Z" fill="#2C7A14" opacity="0.45"/><path d="M-80,900 C80,712 280,750 480,792 C680,834 880,798 1080,828 C1280,858 1480,818 1680,846 L1680,900 Z" fill="#3A8E20" opacity="0.52"/><path d="M-80,900 C160,862 420,872 720,882 C1020,892 1320,864 1680,878 L1680,900 Z" fill="#28700E" opacity="0.38"/></svg>`;
